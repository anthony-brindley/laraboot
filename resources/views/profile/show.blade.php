...
@section('content')
    ...
    <div class="container">
        ...
        <div><h1>Profile:  {{ $profile->first_name. ' ' . $profile->last_name }}</h1></div>
        <div>
            <div class="baseMargin"> <a href="/profile/{{ $profile->id }}/edit"><button type="button" class="btn btn-lg btn-primary">
                        Update</button></a></div>
